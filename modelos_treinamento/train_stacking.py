...
META_TRAIN_REAL = 'modelos_treinamento/archive/test/real'
META_TRAIN_FAKE = 'modelos_treinamento/archive/test/fake'
EVAL_REAL       = 'modelos_treinamento/archive/test/real'
EVAL_FAKE       = 'modelos_treinamento/archive/test/fake'
